        ...
        <main class="main">
            <div class="header">
                ...
                <div class="win-cash fadeinimages">
                    <h2 class="text-white">شكرا على مشاركتك 
                    سيتم ابلاغك اذا كنت رابحا </h2>
                ...
                <div class="submit-receiptbtn">
                    <a href="submit-invoice.php?eid=<?php echo $entryId?>" class="clickhere">اضغط هنا</a>
                    <p class="text-white text-shadow">إذا كنت قد اشتريت 
                    اي منتج بيرت </p>
                    <p class="text-white text-shadow">احصل على فرصة لربح آيفون <span class="english">16</span>
                    و الكثير من الهدايا </p>
