...
if(isset($_REQUEST['btnapprove'])){
  ...
  if (isset($coupon)) {
    ...
    $message .= '<img src="https://winwithamericana.ae/demo/assets/images/email-logo.png" alt="Americana" >' ;
    $message .= '</td>';
    $message .= '</tr>';
    ...
    $headers .= 'From: noreply@winwithamericana.ae' . "\r\n";
    $headers .= 'Reply-To: noreply@winwithamericana.ae' . "\r\n";
        ...
        <section class="content">
          ...
          <div class="box">
            ...
            <tr>
                      ...
                      <img src="../snickersAdmin987/uploads/<?php //if($res['is_arabic']==1) {echo ('../ar/uploads/');} else {echo ('../uploads/');} ?><?php echo $res["invoice_img"]; ?>" />
                      <?php } else{ echo "No-image";} ?></td>
						</tr>
            <tr>
						<th>Product Image</th>
                        <td><?php if($res["product_img"]!=""){ ?>
                      <img src="../snickersAdmin987/uploads/<?php //if($res['is_arabic']==1) {echo ('../ar/uploads/');} else {echo ('../uploads/');} ?><?php echo $res["product_img"]; ?>" />
                      <?php } else{ echo "No-image";} ?></td>
						</tr>
