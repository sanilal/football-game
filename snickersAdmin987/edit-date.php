            ...
            <div class="box-body">
              <form role="form" method="post"  class="form-horizontal" action="" enctype="multipart/form-data">
                  <div class="box-body">
                      ...
                      <input type="date" min='2024-05-13' max='2024-07-20' class="form-control" placeholder="Start Date" name="from" id="cfrom" value="<?php echo $s_res->c_start;  ?>" />
                    </div>
                    <div class="form-group">
                      <label>End Date</label>
                      <input type="date" min='2024-02-15' max='2024-04-20' class="form-control" placeholder="End Date" name="to" id="cto" value="<?php echo $s_res->c_ends;  ?>" />
                    </div>
