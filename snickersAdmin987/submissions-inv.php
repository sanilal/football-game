...
if(isset($_GET['remove_pr'])){
 ...
 $sql = "SELECT * FROM `" . TB_pre . "shop_win` WHERE invoice_no IS NOT NULL AND invoice_no != '' ORDER BY entry_id DESC";
...
?>  
    ...
    <?php endif; ?>
                        ...
                        <a href="javascript:removeItem(<?php echo $res['entry_id']; ?>);" class="btn btn-danger">Remove</a>
