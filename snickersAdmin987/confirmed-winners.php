...
$sql="select * from `".TB_pre."shop_win` WHERE `approved` = 1 ORDER BY `entry_id` ASC ";
                  ...
                  <table id="example2" class="table table-bordered table-hover center-table" style="width: 100%; max-width: 90%; float: left;">
					...
					while($res = mysqli_fetch_array($r1)){ ?>
                      <tr>
                        ...
                        <td><?php
                        $wsql = "SELECT * FROM `" . TB_pre . "shop_win` WHERE `entry_id` = '" . $res['entry_id'] . "' ";
                        ...
                        echo $user['first_name'] ." ". $user['last_name'] ;?></td>
                         ...
                         <td><a href="#" > <img width="75px" src="../snickersAdmin987/uploads/<?php echo $user['invoice_img']; ?>" alt=""></a></td>
...
<script>
  ...
  //         XLSX.writeFile(wb, fn || ('Americana.' + (type || 'xlsx')));
  // }
