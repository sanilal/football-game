...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['reject'])) {
  ...
  $update_prize_query = "UPDATE `" . TB_pre . "shop_win` 
  ...
  if ($result) {
      ...
      $prize_sql = "SELECT * FROM `" . TB_pre . "shop_win` WHERE `entry_id` = '$entry_id'";
    ...
    // You can add any additional logic here if needed
           ...
           $re_query = "INSERT INTO `".TB_pre."rejections` (`prize_id`, `entry_id`, `reason`, `rejection_time`) 
                       VALUES ('0', '$entry_id', '$reason', '$rejection_time')";
            ...
            <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
					...
					while($res = mysqli_fetch_array($r1)){ ?>
                      ...
                      <img src="../snickersAdmin987/uploads/<?php echo $res["invoice_img"]; ?>" style="width:150px; height:auto;"/>
                      <?php } else{ echo "No-image";} ?></td>
						</tr>
						<!-- <tr>
							<th>Image</th>
